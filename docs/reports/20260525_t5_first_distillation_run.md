...
| # | Tier | Status | Note |
|---|---|---|---|
| 73 | T0 Inventory | done | |
| 74 | T1 Proxy pipeline | done | |
| 75 | T2 E2B baseline | done | found mlx-lm Gemma 4 blocker -> pivoted to 3n |
| 79 | N=20 untuned baseline | done | Δ=-1.32, fine-tuning justified |
| 76 | T3 Mini-smoke | done | fixed LoRA `keys:` for Gemma 3n's `altup` |
| 77 | T4 Full smoke | done | 8.99 GB peak, well under 13 GB budget |
| 78 | **T5 Real training + eval** | done | **Δ=-0.67 (halved). Pipeline shippable.** |
